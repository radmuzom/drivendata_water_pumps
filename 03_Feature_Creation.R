...
dtz <- designTreatmentsZ(train_values, "region")
train_dtz <- prepare(dtz, train_values)
train_dtz <- train_dtz[, -1]
test_dtz <- prepare(dtz, test_values)
test_dtz <- test_dtz[, -1]
...
dtz <- designTreatmentsZ(train_values, "payment_type")
train_dtz <- prepare(dtz, train_values)
train_dtz <- train_dtz[, -1]
test_dtz <- prepare(dtz, test_values)
test_dtz <- test_dtz[, -1]
...
dtz <- designTreatmentsZ(train_values, "quantity")
train_dtz <- prepare(dtz, train_values)
train_dtz <- train_dtz[, -1]
test_dtz <- prepare(dtz, test_values)
test_dtz <- test_dtz[, -1]
...
dtz <- designTreatmentsZ(train_values, "waterpoint_type")
train_dtz <- prepare(dtz, train_values)
train_dtz <- train_dtz[, -1]
test_dtz <- prepare(dtz, test_values)
test_dtz <- test_dtz[, -1]
